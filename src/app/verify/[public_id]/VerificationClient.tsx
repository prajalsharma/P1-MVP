    ...
    async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      setVerifyState("verifying");
        ...
        try {
          ...
          // Requirement: Must include the record's original creation timestamp 
          // in the hash calculation to verify authenticity.
          const { fingerprint } = await hashFile(file, data.created_at!);
          ...
          <dl className={styles.detailList}>
            ...
            <div className={styles.detailRow}>
              ...
              <div className={styles.detailRow}>
                ...
                <dd className={styles.detailValue}>{data.created_at && formatTimestamp(data.created_at)}</dd>
              </div>
              ...
              {data.events.map((event, idx) => (
                <li key={idx} className={styles.timelineItem}>
                  ...
                  <div className={styles.timelineContent}>
                      ...
                      <span className={styles.timelineTime}>{formatTimestamp(event.occurred_at)}</span>
                    </div>
                  </li>
                ))}
              </ol>
            ...
            <section className={styles.card}>
              ...
              <dl className={styles.detailList}>
                ...
                {data.chain_timestamp && (
                  <div className={styles.detailRow}>
                    <dt className={styles.detailLabel}>Observed Time</dt>
                    <dd className={styles.detailValue}>{formatTimestamp(data.chain_timestamp)}</dd>
                  </div>
                )}
