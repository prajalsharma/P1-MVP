...
...
  ...
  const handleCopyLink = useCallback(async (publicId: string, anchorId: string) => {
                  ...
                  <td className={styles.td}>
                    <div className={styles.actionRow}>
                      <button
                        ...
                        onClick={() => handleCopyLink(a.public_id, a.id)}
                        aria-label={copiedId === a.id ? "Link copied" : "Copy verification link"}
                      >
